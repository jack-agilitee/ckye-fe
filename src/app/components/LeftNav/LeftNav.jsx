...
const imgIcon2 = "http://localhost:3845/assets/70e35d22be685a238179aaff57dafde310deef87.svg";

const ChevronDown = ({ style = "Regular" }) => {
  return (
...
const Note = ({ style = "Regular" }) => {
  ...
  return (
    <div className="left-nav__note" onClick={handleNoteClick}>
...
const ListItem = ({ 
  ...
  return (
    <div 
      className={`left-nav__list-item ${isSelected ? 'left-nav__list-item--selected' : ''} ${isHovered ? 'left-nav__list-item--hovered' : ''}`}
      onClick={handleClick}
...
const Documents = ({ style = "Regular" }) => {
  return (
    <div className="left-nav__documents">
      <div className="left-nav__documents-icon">
        <img alt="" className="left-nav__documents-img" src={imgIcon2} />
      </div>
    </div>
  );
};
...
const LeftNav = ({ onAccountModalToggle }) => {
  ...
  return (
    <div className="left-nav">
      <div className="left-nav__account-changer" onClick={handleAccountClick}>
        ...
        <div className="left-nav__sections">
          <div className="left-nav__context-section">
            ...
            <div className="left-nav__file-list">
              ...
              <div className="left-nav__add-new" onClick={handleAddNewClick}>
